...
To optimize the MonolithicDemoApplication application for production, run:
...
[Doing API-First development]: http://www.jhipster.tech/documentation-archive/v4.8.2/doing-api-first-development/
